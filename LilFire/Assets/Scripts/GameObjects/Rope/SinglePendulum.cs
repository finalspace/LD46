...
public class SinglePendulum : MonoBehaviour
{
    ...
    {
        //free pendulum
        SpringUtil.Spring(ref x, ref v, xt, 0f, 1.0f * Mathf.PI, Time.deltaTime);
        Vector3 offset = new Vector3(Mathf.Sin(x), -Mathf.Cos(x)) * segmentLength * ropeSegLen;
        pos = StartPoint.position + offset;
