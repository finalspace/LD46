...
////// Emissive:
                ...
                float4 node_9946 = _Time + _TimeEditor;
                float2 node_839 = ((i.uv0+node_9946.g*float2(0.2,0))*0.2);
                float4 _WaveNoise1_var = tex2D(_WaveNoise1,TRANSFORM_TEX(node_839, _WaveNoise1));
                float2 node_9892 = ((i.uv0+node_9946.g*float2(-0.1,0))*0.2);
                ...
                float node_1572 = 1.0;
                float node_603 = (_MainTex_var.a*_Color.a*i.vertexColor.a*node_1524.a*lerp((node_7801_if_leA*node_1572)+(node_7801_if_leB*node_1572),node_1572,node_7801_if_leA*node_7801_if_leB)); // A
