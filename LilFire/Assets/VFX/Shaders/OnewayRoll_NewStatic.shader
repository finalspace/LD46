...
/*SF_DATA;ver:1.37;sub:START;pass:START;ps:flbk:,iptp:1,cusa:True,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:True,tesm:0,olmd:1,culm:2,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:True,fnsp:True,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:1873,x:33615,y:32553,varname:node_1873,prsc:2|emission-1785-OUT,alpha-7549-OUT;n:type:ShaderForge.SFN_Tex2d,id:4805,x:32228,y:33074,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:_MainTex_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:True,tagnsco:False,tagnrm:False,tex:6337f74ea4d0447fcabf466fbeb336d8,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:1086,x:32522,y:32869,cmnt:RGB,varname:node_1086,prsc:2|A-4805-RGB,B-5983-RGB,C-5376-RGB;n:type:ShaderForge.SFN_Color,id:5983,x:32228,y:33257,ptovrint:False,ptlb:Color,ptin:_Color,varname:_Color_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_VertexColor,id:5376,x:32228,y:33406,varname:node_5376,prsc:2;n:type:ShaderForge.SFN_Multiply,id:1749,x:33008,y:32739,cmnt:Premultiply Alpha,varname:node_1749,prsc:2|A-1086-OUT,B-603-OUT;n:type:ShaderForge.SFN_Multiply,id:603,x:32887,y:33247,cmnt:A,varname:node_603,prsc:2|A-4805-A,B-5983-A,C-5376-A,D-817-OUT;n:type:ShaderForge.SFN_Tex2d,id:9749,x:30453,y:31630,ptovrint:False,ptlb:WaveTexture,ptin:_WaveTexture,varname:node_9749,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:2437492445a014c40af8c893bb55a062,ntxv:0,isnm:False|UVIN-4641-OUT;n:type:ShaderForge.SFN_TexCoord,id:7027,x:29500,y:32273,varname:node_7027,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Tex2d,id:3227,x:30469,y:32127,ptovrint:False,ptlb:FoamTexture,ptin:_FoamTexture,varname:node_3227,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:193afb049ac9a444599fde13915a87ea,ntxv:0,isnm:False|UVIN-6248-OUT;n:type:ShaderForge.SFN_TexCoord,id:9919,x:29097,y:31802,varname:node_9919,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Panner,id:4338,x:29333,y:31619,varname:node_4338,prsc:2,spu:0,spv:0.02|UVIN-9919-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:6339,x:29516,y:31619,ptovrint:False,ptlb:WaveNoise,ptin:_WaveNoise,varname:node_6339,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:9789d23040cb1fb45ad60392430c3c15,ntxv:0,isnm:False|UVIN-4338-UVOUT;n:type:ShaderForge.SFN_Add,id:4641,x:30191,y:31751,varname:node_4641,prsc:2|A-6457-OUT,B-9919-UVOUT;n:type:ShaderForge.SFN_RemapRange,id:3873,x:29781,y:31616,varname:node_3873,prsc:2,frmn:0,frmx:1,tomn:-0.02,tomx:0.02|IN-6339-R;n:type:ShaderForge.SFN_Clamp01,id:5266,x:31231,y:32254,varname:node_5266,prsc:2|IN-3601-OUT;n:type:ShaderForge.SFN_Add,id:6248,x:30184,y:32123,varname:node_6248,prsc:2|A-6457-OUT,B-8578-OUT;n:type:ShaderForge.SFN_Slider,id:388,x:31471,y:31647,ptovrint:False,ptlb:Brightness,ptin:_Brightness,varname:node_388,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.8299111,max:10;n:type:ShaderForge.SFN_Slider,id:8318,x:31019,y:32508,ptovrint:False,ptlb:FoamOpacity,ptin:_FoamOpacity,varname:node_8318,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.2872095,max:5;n:type:ShaderForge.SFN_Time,id:2983,x:29008,y:32044,varname:node_2983,prsc:2;n:type:ShaderForge.SFN_Add,id:9353,x:29755,y:32513,varname:node_9353,prsc:2|A-7027-V,B-1256-OUT;n:type:ShaderForge.SFN_Slider,id:9462,x:28851,y:32424,ptovrint:False,ptlb:FoamSpeed,ptin:_FoamSpeed,varname:node_9462,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-1,cur:-0.1,max:1;n:type:ShaderForge.SFN_Multiply,id:1256,x:29328,y:32487,varname:node_1256,prsc:2|A-2983-T,B-9462-OUT;n:type:ShaderForge.SFN_Append,id:8578,x:29941,y:32253,varname:node_8578,prsc:2|A-7027-U,B-9353-OUT;n:type:ShaderForge.SFN_Slider,id:9447,x:29611,y:31478,ptovrint:False,ptlb:NoisePower,ptin:_NoisePower,varname:node_9447,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.2961822,max:5;n:type:ShaderForge.SFN_Multiply,id:6457,x:29968,y:31581,varname:node_6457,prsc:2|A-9447-OUT,B-3873-OUT;n:type:ShaderForge.SFN_Tex2d,id:6682,x:30469,y:31906,ptovrint:False,ptlb:FoamDetailMask,ptin:_FoamDetailMask,varname:node_6682,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:c05193f65b84945c38f8c52a0cc4175f,ntxv:0,isnm:False|UVIN-4641-OUT;n:type:ShaderForge.SFN_Multiply,id:1785,x:33169,y:32326,varname:node_1785,prsc:2|A-3860-OUT,B-1086-OUT;n:type:ShaderForge.SFN_Multiply,id:3601,x:31038,y:32254,varname:node_3601,prsc:2|A-1602-OUT,B-3227-A;n:type:ShaderForge.SFN_Multiply,id:8861,x:31447,y:32337,varname:node_8861,prsc:2|A-5266-OUT,B-8318-OUT;n:type:ShaderForge.SFN_Add,id:3860,x:32786,y:32333,varname:node_3860,prsc:2|A-9673-OUT,B-7458-OUT;n:type:ShaderForge.SFN_Multiply,id:9673,x:31609,y:31491,varname:node_9673,prsc:2|A-9749-RGB,B-388-OUT;n:type:ShaderForge.SFN_Slider,id:870,x:33029,y:33439,ptovrint:False,ptlb:OverallOpcity,ptin:_OverallOpcity,varname:node_870,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:8.292268,max:20;n:type:ShaderForge.SFN_Multiply,id:7549,x:33253,y:33222,varname:node_7549,prsc:2|A-603-OUT,B-870-OUT;n:type:ShaderForge.SFN_Add,id:817,x:31665,y:31829,varname:node_817,prsc:2|A-9749-A,B-8861-OUT;n:type:ShaderForge.SFN_Power,id:1602,x:30804,y:31979,varname:node_1602,prsc:2|VAL-6682-A,EXP-835-OUT;n:type:ShaderForge.SFN_Slider,id:835,x:30647,y:31910,ptovrint:False,ptlb:FoamPower,ptin:_FoamPower,varname:node_835,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1.810144,max:5;n:type:ShaderForge.SFN_Color,id:4282,x:31339,y:31901,ptovrint:False,ptlb:node_4282,ptin:_node_4282,varname:node_4282,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:7458,x:31771,y:32085,varname:node_7458,prsc:2|A-4282-RGB,B-8861-OUT,C-6432-OUT;n:type:ShaderForge.SFN_Slider,id:6432,x:31804,y:32261,ptovrint:False,ptlb:node_6432,ptin:_node_6432,varname:node_6432,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1.037195,max:10;proporder:4805-5983-9749-3227-6339-388-8318-9462-9447-6682-870-835-4282-6432;pass:END;sub:END;*/

Shader "DDT/OnewayRollDetailStatic" {
    Properties {
        ...
        _Brightness ("Brightness", Range(0, 10)) = 0.8299111
        _FoamOpacity ("FoamOpacity", Range(0, 5)) = 0.2872095
        _FoamSpeed ("FoamSpeed", Range(-1, 1)) = -0.1
        _NoisePower ("NoisePower", Range(0, 5)) = 0.2961822
        _FoamDetailMask ("FoamDetailMask", 2D) = "white" {}
        _OverallOpcity ("OverallOpcity", Range(0, 20)) = 8.292268
        _FoamPower ("FoamPower", Range(0, 5)) = 1.810144
        _node_4282 ("node_4282", Color) = (1,1,1,1)
        _node_6432 ("node_6432", Range(0, 10)) = 1.037195
...
////// Lighting:
////// Emissive:
                float4 node_1525 = _Time + _TimeEditor;
                float2 node_4338 = (i.uv0+node_1525.g*float2(0,0.02));
                ...
                float2 node_4641 = (node_6457+i.uv0);
                ...
                float node_8861 = (saturate((pow(_FoamDetailMask_var.a,_FoamPower)*_FoamTexture_var.a))*_FoamOpacity);
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float3 node_1086 = (_MainTex_var.rgb*_Color.rgb*i.vertexColor.rgb); // RGB
                float3 emissive = (((_WaveTexture_var.rgb*_Brightness)+(_node_4282.rgb*node_8861*_node_6432))*node_1086);
                float3 finalColor = emissive;
                float node_603 = (_MainTex_var.a*_Color.a*i.vertexColor.a*(_WaveTexture_var.a+node_8861)); // A
