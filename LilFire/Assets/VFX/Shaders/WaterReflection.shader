...
////// Emissive:
                ...
                float3 emissive = ((_ReflectionColor.rgb*step(_ReflectionRange,dot(float3(0,0,1),normalize(lerp(float3(0,0,1),node_3378,_Reflection))))*_ReflectionPower)+((_MainTex_var.rgb*_Color.rgb*i.vertexColor.rgb)*node_603 * _Brightness));
